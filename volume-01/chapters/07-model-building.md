...
Adjust for factors that could distort the smoking–exacerbation link. Formally: conditional association given measured covariates; unmeasured confounding may remain.
...
LASSO picks a sparse predictor set that predicts exacerbation in cross-validation. Formally: penalized logistic regression with λ chosen by CV; coefficients are biased but prediction may improve.
