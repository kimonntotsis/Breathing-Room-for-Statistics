...
**How to use this appendix:** read one story that matches your week, then open the linked chapter. Full short read: [Appendix J](appendix-j-investigator-minimum-path.md).
